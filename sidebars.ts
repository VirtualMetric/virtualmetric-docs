      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              label: "Amazon",
              items: [
                "configuration/targets/amazon/amazon-security-lake",
                "configuration/targets/amazon/amazon-s3",
                "configuration/targets/amazon/amazon-cloudwatch",
                "configuration/targets/amazon/amazon-kinesis",
                "configuration/targets/amazon/amazon-msk",
                "configuration/targets/amazon/amazon-opensearch",
                "configuration/targets/amazon/amazon-redshift",
                "configuration/targets/amazon/amazon-sns",
                "configuration/targets/amazon/amazon-sqs",
              ],
            },
            {
              type: "category",
        ...
        },
        {
          ...
          items: [
            ...
            "configuration/pipelines/debugging",
            {
              type: "category",
              label: "Processors",
              items: [
