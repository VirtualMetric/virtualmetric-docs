...
<Include id="component-enablement" />
...
:::note
Mapping the data fields of disparate log formats to widely known <Topic id="appendix-ecs">ECS</Topic> fields is one of the commonly used <Topic id="pipelines-normalization">normalization</Topic> techniques.
:::
...
<Include id="live-config-updates" />
...
- Log file indicated <Topic id="examples-logging-setup">earlier</Topic> shows no errors
