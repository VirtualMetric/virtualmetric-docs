...
<Tabs groupId="integration-method">
  ...
  <TabItem value="manual" label="Manual">
    **Director** needs permissions to send data to your manually configured _Data Collection Rules_.
  </TabItem>
</Tabs>
...
<Tabs groupId="integration-method">
  ...
  <TabItem value="manual" label="Manual">
    ...
    4. Assign the following permissions:
      |Role|Assignee|
      |---|---|
      |Monitoring Metrics Publisher|Your _Service Principal_ or _Application_|
