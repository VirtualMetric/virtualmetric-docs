...
First, create a file named `csv-consumer.yml` in our <Topic id="tutorials-working-dir">working directory</Topic>. You will use this file to define your pipeline.
