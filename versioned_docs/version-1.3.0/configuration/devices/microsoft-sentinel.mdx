...
Incidents are automatically normalized with ECS field mapping in addition to using consistent timestamp formats, structured label handling, and owner information. (See <Topic id="appendix-ecs">Appendix</Topic> for details of ECS.)
