...
After installation, the template content appears as a pipeline in **DataStream**. See <Topic id="gui-managing-templates-installation">**this section**</Topic> for installation and management steps.
