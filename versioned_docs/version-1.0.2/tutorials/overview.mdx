...
The sections of the tutorial require the following basic setup, tools, and sample data.

## Tools

Make sure you have an open terminal to enter the commands in the following sections
