...
:::tip
For more details, refer to our [Microsoft Sentinel Automation](/docs/microsoft-sentinel/index.mdx) and [Microsoft Sentinel Autodiscovery](/docs/microsoft-sentinel/integration/autodiscovery.mdx) documentation.
:::
