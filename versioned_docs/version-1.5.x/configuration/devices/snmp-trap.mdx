...
|`authentication.protocol`|N|`1`|Authentication protocol ID. See <Topic id="snmp-authentication">table</Topic> below|
...
|Field|Required|Default|Description|
|---|---|---|---|
|`privacy.protocol`|N|`1`|Privacy protocol ID. See <Topic id="snmp-privacy">table</Topic> below|
