...
sidebar_custom_props:
  ...
  customTags: ["Networking"]
---

# Community ID

<span className="theme-doc-version-badge badge badge--primary">Security</span><span className="theme-doc-version-badge badge badge--secondary">Networking</span>
