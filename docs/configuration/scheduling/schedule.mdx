...
Schedule allows you to execute targets and routes at specific times using cron expressions. Instead of running continuously, the component will only process data when the schedule condition is met.
