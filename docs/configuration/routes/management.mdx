...
- Click <gui>+</gui> button to add device to flow
...
- Click <gui>+</gui> button to add target to flow
...
2. Click <gui>+</gui> button on device box
...
2. Click <gui>+</gui> button on target box
...
4. Click <gui>Select</gui> to add pipeline to connection
...
Filter routes using **Search routes** (by name) and **Status** dropdown (All, Active, Passive). The <gui>Refresh</gui> button reloads table data. Click <gui>Create advanced route</gui> to launch the creation wizard.
...
**View and Edit:**
- <gui>Edit route</gui> - Navigate to route edit interface
- <gui>View details</gui> - Navigate to route detail view

**Status Management:**
- <gui>Activate Route</gui> - Set route to Active status
- <gui>Deactivate Route</gui> - Set route to Passive status

**Deletion:**
- <gui>Delete Route</gui> - Remove route from platform
...
**Create Route:**
- <gui>Create Route</gui> button finalizes configuration
...
**Navigation Buttons:**
- <gui>Cancel</gui> - Exit wizard without creating route
- <gui>Back</gui> - Return to previous step
- <gui>Next</gui> - Advance to next step with validation
- <gui>Create Route</gui> - Finalize route creation (final step)
...
3. Select <gui>Activate Route</gui> or <gui>Deactivate Route</gui>
