...
- Click <menu>+</menu> button to add device to flow
...
- Click <menu>+</menu> button to add target to flow
...
2. Click <menu>+</menu> button on device box
...
2. Click <menu>+</menu> button on target box
...
4. Click <menu>Select</menu> to add pipeline to connection
...
Filter routes using **Search routes** (by name) and **Status** dropdown (All, Active, Passive). The <menu>Refresh</menu> button reloads table data. Click <menu>Create advanced route</menu> to launch the creation wizard.
...
**View and Edit:**
- <menu>Edit route</menu> - Navigate to route edit interface
- <menu>View details</menu> - Navigate to route detail view

**Status Management:**
- <menu>Activate Route</menu> - Set route to Active status
- <menu>Deactivate Route</menu> - Set route to Passive status

**Deletion:**
- <menu>Delete Route</menu> - Remove route from platform
...
**Create Route:**
- <menu>Create Route</menu> button finalizes configuration
...
**Navigation Buttons:**
- <menu>Cancel</menu> - Exit wizard without creating route
- <menu>Back</menu> - Return to previous step
- <menu>Next</menu> - Advance to next step with validation
- <menu>Create Route</menu> - Finalize route creation (final step)
...
3. Select <menu>Activate Route</menu> or <menu>Deactivate Route</menu>
