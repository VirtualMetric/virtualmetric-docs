...
<img src={useBaseUrl('/img/graphics/data-flow.svg')} alt="Data Flow" style={{height: "300"}}/>
...
<img src={useBaseUrl('/img/graphics/directory-tree.svg')} alt="Directory Tree" style={{height: "300"}}/>
