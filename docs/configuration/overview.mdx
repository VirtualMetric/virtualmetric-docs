...
- **Indirectly** - with the so-called _mustache_ syntax:
...
Fields within data structures are referred to using the _dot_ notation:
...
:::tip
Refer to component-specific documentation for details on the available options.
:::
