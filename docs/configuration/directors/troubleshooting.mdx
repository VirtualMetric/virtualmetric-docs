...
1. **Verify Regional Endpoint**
   - Confirm you are using the correct regional URL for your account:
   ...
   - Select your region at [virtualmetric.com/select-your-region-login](https://www.virtualmetric.com/select-your-region-login/)

2. **Validate Network Connectivity**
   - Ensure port 443 is open for outbound HTTPS connections
   - Verify DNS resolution is working properly
   - Test connectivity to your regional endpoint
...
4. **Validate API Key**
   ...
   - Regenerate API key from the dashboard if corruption is suspected

5. **Review System Time**
   - Ensure system clock is synchronized (required for certificate validation)
...
<Tabs>
  <TabItem value="powershell" label="PowerShell" default>
    ```powershell
    # Test DNS resolution (replace with your region)
    Resolve-DnsName app.eu-west.cloud.virtualmetric.com

    # Check outbound connectivity
    Test-NetConnection -ComputerName app.eu-west.cloud.virtualmetric.com -Port 443

    # Verify TLS connectivity
    Invoke-WebRequest -Uri "https://app.eu-west.cloud.virtualmetric.com" -Method Head -UseBasicParsing
    ```
  </TabItem>
  <TabItem value="bash" label="Bash">
    ```bash
    # Test DNS resolution (replace with your region)
    nslookup app.eu-west.cloud.virtualmetric.com

    # Check outbound connectivity
    nc -zv app.eu-west.cloud.virtualmetric.com 443

    # Verify TLS connectivity
    curl -I https://app.eu-west.cloud.virtualmetric.com
    ```
  </TabItem>
</Tabs>
...
2. **Contact Support**
   - Submit support ticket at [support.virtualmetric.com](https://support.virtualmetric.com)
