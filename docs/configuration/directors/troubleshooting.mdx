...
For Directors in a cluster, troubleshoot each Director individually using the procedures above. Cluster health is an aggregation of individual Director states.
:::
