...
Filter Directors using **Search directors** (by name) and **Status** dropdown (All, Enabled, Disabled). The <menu>Refresh</menu> button reloads table data. Click <menu>Create director</menu> to launch the creation wizard (requires DIRECTOR_CREATE permission).
...
**View Details:**
- <menu>See details</menu> - Navigate to Director detail view

**Status Management:**
- <menu>Enable Director</menu> - Activate disabled Director
- <menu>Disable Director</menu> - Deactivate enabled Director

**Configuration:**
- <menu>Download Config</menu> - Download vmetric.vmf configuration file (Self-Managed only)

**Deletion:**
- <menu>Delete Director</menu> - Remove Director from platform
...
- <menu>Complete Setup</menu> - Finalize and navigate to Director detail view
- Automatic redirect to Director detail page

**Not Yet Connected:**
- <menu>Connect Later</menu> - Save Director configuration without connection verification
- <menu>Complete Setup</menu> - Disabled until successful connection
...
**Navigation Buttons:**
- <menu>Cancel</menu>/<menu>Connect Later</menu> - Exit wizard (label changes on final step)
- <menu>Create Director</menu> - Advance to next step with validation
- <menu>Complete Setup</menu> - Finalize Director creation (final step)
...
**Edit Functionality:**
- <menu>Edit</menu> icon on tiles for inline editing
- <menu>Save</menu> changes with validation
- <menu>Cancel</menu> to discard modifications
...
3. Select <menu>Enable Director</menu> or <menu>Disable Director</menu>
...
2. Click **Actions** menu
3. Select <menu>Download Config</menu>
...
2. Click **Actions** menu
3. Select <menu>Delete Director</menu>
