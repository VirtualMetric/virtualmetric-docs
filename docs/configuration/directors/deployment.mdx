...
- **Windows Agentless**: Not supported

:::warning
Windows Agentless monitoring from Linux Directors is not supported due to Microsoft's deprecation of WinRM. Use VirtualMetric Agent for Windows endpoint monitoring instead.
:::
