...
3. The <Topic id="processors-commit">commit</Topic> processor can be used for early commit when you need to send staged events before the pipeline completes
4. Without explicit commit, the final staged version is automatically sent at pipeline end
