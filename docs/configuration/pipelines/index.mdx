...
<table>
  <tr>
    <td align="center"><strong>Provider</strong><br/>(data source)</td>
    <td align="center">&rarr;</td>
    <td align="center"><strong>Pipeline</strong><br/>(transformation)</td>
    <td align="center">&rarr;</td>
    <td align="center"><strong>Consumer</strong><br/>(destination)</td>
  </tr>
  <tr>
    <td>
      <em>Raw data</em>
...
**Provider** (data source) &rarr; **Pipeline** (processor-1, processor-2, ..., processor-n) &rarr; **Consumer** (destination)
...
A pipeline can consume data from multiple providers, and&mdash;once it is finished processing them&mdash;can direct some or all of the processed data to a specific consumer in a _one-to-one_ scheme:

<table>
  <tr>
    <td align="center" colspan="2"><strong>Providers</strong><br/>(data sources)</td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Pipeline</strong><br/>(transformation)</td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Consumer</strong><br/>(destination)</td>
  </tr>
  <tr>
    <td align="center"><strong>Provider 1</strong></td>
    <td align="center"><strong>Provider 2</strong></td>
  </tr>
  <tr>
    <td>
      Data A<br/>
...
<table>
  <tr>
    <td align="center" rowspan="2"><strong>Provider</strong><br/>(data source)</td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Pipeline</strong><br/>(transformation)</td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" colspan="2"><strong>Consumers</strong><br/>(destinations)</td>
  </tr>
  <tr>
    <td align="center"><strong>Consumer 1</strong></td>
    <td align="center"><strong>Consumer 2</strong></td>
  </tr>
  <tr>
    <td>
      Data A<br/>
...
<table>
  <tr>
    <td align="center" colspan="3"><strong>Providers</strong><br/>(data sources)</td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Pipeline</strong><br/>(transformation)</td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" colspan="2"><strong>Consumers</strong><br/>(destinations)</td>
  ...
  <tr>
    <td align="center"><strong>Provider 1</strong></td>
    <td align="center"><strong>Provider 2</strong></td>
    <td align="center"><strong>Provider 3</strong></td>
    <td align="center"><strong>Consumer 1</strong></td>
    <td align="center"><strong>Consumer 2</strong></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td align="center" colspan="3"><strong>Sources</strong></td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Preprocess</strong></td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Routes</strong></td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Postprocess</strong></td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" colspan="2"><strong>Targets</strong></td>
  </tr>
  <tr>
    <td align="center"><strong>Source 1</strong></td>
    <td align="center"><strong>Source 2</strong></td>
    <td align="center"><strong>Source 3</strong></td>
    <td align="center"><strong>Target 1</strong></td>
    <td align="center"><strong>Target 2</strong></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" colspan="2"><strong>Sources</strong></td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Routing</strong><br/>(transformation)</td>
    <td align="center" rowspan="2">&rarr;</td>
    <td align="center" rowspan="2"><strong>Target</strong></td>
  </tr>
  <tr>
    <td align="center"><strong>Source 1</strong></td>
    <td align="center"><strong>Source 2</strong></td>
