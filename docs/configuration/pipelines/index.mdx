...
- Begin with validation processors to ensure data quality, and validate behavior with representative sample data
- Arrange processors logically by extracting fields before using them, and apply processors selectively to improve performance
- Configure appropriate error handling
- Watch for processor bottlenecks in high-volume environments
