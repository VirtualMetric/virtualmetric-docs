...
<span className="theme-doc-version-badge badge badge--primary">Threat Intelligence</span><span className="theme-doc-version-badge badge badge--secondary">Web Standards</span>
...
|---|---|---|---|
|`field`|N|`ip`|Field containing the value to analyze|
|`api_key`|Y|-|IPQS API key|
|`query_type`|Y|`ip`|Type of query: `ip`, `email`, `url`, or `phone`|
