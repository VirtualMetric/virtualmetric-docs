...
For more complex string manipulation, consider using the <Topic id="processors-set">`set`</Topic> processor and the so-called [**mustache**](../../overview.mdx#scoping-and-referencing) syntax.
