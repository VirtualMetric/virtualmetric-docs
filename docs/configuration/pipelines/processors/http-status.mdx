...
:::info
This processor includes extended status codes from popular web servers (IIS, Apache, Nginx), CDNs (Cloudflare, Amazon), and load balancers for comprehensive web traffic analysis.
:::
