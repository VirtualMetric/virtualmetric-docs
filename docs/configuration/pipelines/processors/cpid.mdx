...
<span className="theme-doc-version-badge badge badge--primary">Analytics</span><span className="theme-doc-version-badge badge badge--secondary">Networking</span>

## Synopsis

Generates a CPID (Common Process ID) according to [RFC 9562](https://www.rfc-editor.org/rfc/rfc9562.html).
