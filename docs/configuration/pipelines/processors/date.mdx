...
<span className="theme-doc-version-badge badge badge--primary">Date and Time</span><span className="theme-doc-version-badge badge badge--secondary">Elastic Compatible</span>
