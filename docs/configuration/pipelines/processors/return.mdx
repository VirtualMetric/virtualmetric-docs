...
Exits early from the current processor block (<Topic id="processors-group">group</Topic>, <Topic id="processors-pipeline">pipeline</Topic>, or <Topic id="processors-foreach">foreach</Topic>), similar to a `return` statement in programming languages.
