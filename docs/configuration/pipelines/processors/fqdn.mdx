...
Parses _Fully Qualified Domain Names_ (FQDNs), URLs, and hostnames to extract individual components like hostname, domain, domain type, and normalized FQDN using ASIM logic.
