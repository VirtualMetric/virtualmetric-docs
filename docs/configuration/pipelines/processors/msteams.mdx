...
|---|---|---|---|
|`webhook_url`|Y|-|Microsoft Teams incoming webhook URL|
|`title`|Y|-|Card title displayed prominently|
|`text`|Y|-|Main message body text|
|`subtitle`|N|-|Subtitle displayed below the title|
|`image`|N|-|URL to image displayed in the card|
|`theme_color`|N|-|Card accent color: `good`, `warning`, `danger`, `info`, or hex code|
|`width`|N|-|Card width: `Full` for full-width cards|
