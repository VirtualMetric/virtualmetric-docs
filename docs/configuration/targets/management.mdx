...
Filter targets using **Search targets** (by name) and **Status** dropdown (All, Enabled, Disabled). The <gui>Refresh</gui> button reloads table data. Click <gui>Create target</gui> to launch the creation wizard.
...
**View Details:**
- <gui>See details</gui> - Navigate to target detail view

**Status Management:**
- <gui>Enable Target</gui> - Activate disabled target
- <gui>Disable Target</gui> - Deactivate enabled target

**Configuration:**
- <gui>Clone Target</gui> - Duplicate target configuration for quick setup

**Deletion:**
- <gui>Delete Target</gui> - Remove target from platform
...
**Navigation Buttons:**
- <gui>Cancel</gui> - Exit wizard without creating target
- <gui>Back</gui> - Return to previous step
- <gui>Next</gui> - Advance to next step with validation
- <gui>Create target</gui> - Finalize target creation (final step)
...
**Advanced Operations:**
- <gui>Clone Target</gui> - Duplicate configuration for new target
- <gui>Delete Target</gui> - Remove target from platform
...
3. Select <gui>Enable Target</gui> or <gui>Disable Target</gui>
...
1. Navigate to target detail view or use Actions menu from list
2. Click **Actions** menu
3. Select <gui>Delete Target</gui>
