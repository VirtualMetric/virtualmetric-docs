...
Filter targets using **Search targets** (by name) and **Status** dropdown (All, Enabled, Disabled). The <menu>Refresh</menu> button reloads table data. Click <menu>Create target</menu> to launch the creation wizard.
...
**View Details:**
- <menu>See details</menu> - Navigate to target detail view

**Status Management:**
- <menu>Enable Target</menu> - Activate disabled target
- <menu>Disable Target</menu> - Deactivate enabled target

**Configuration:**
- <menu>Clone Target</menu> - Duplicate target configuration for quick setup

**Deletion:**
- <menu>Delete Target</menu> - Remove target from platform
...
**Navigation Buttons:**
- <menu>Cancel</menu> - Exit wizard without creating target
- <menu>Back</menu> - Return to previous step
- <menu>Next</menu> - Advance to next step with validation
- <menu>Create target</menu> - Finalize target creation (final step)
...
**Advanced Operations:**
- <menu>Clone Target</menu> - Duplicate configuration for new target
- <menu>Delete Target</menu> - Remove target from platform
...
3. Select <menu>Enable Target</menu> or <menu>Disable Target</menu>
...
2. Click **Actions** menu
3. Select <menu>Clone Target</menu>
...
1. Navigate to target detail view or use Actions menu from list
2. Click **Actions** menu
3. Select <menu>Delete Target</menu>
