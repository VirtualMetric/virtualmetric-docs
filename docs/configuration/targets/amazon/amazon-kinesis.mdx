...
Kinesis automatically encrypts data at rest using Amazon KMS. Data in transit is encrypted using TLS. All connections to Kinesis use HTTPS endpoints.
...
Kinesis Data Streams integrates with other Amazon services:
