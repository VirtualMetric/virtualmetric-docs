...
<span className="theme-doc-version-badge badge badge--secondary">Amazon</span><span className="theme-doc-version-badge badge badge--secondary">Data Warehouse</span>
...
|Field|Required|Default|Description|
|---|---|---|---|
|`key`|N*|-|Amazon access key ID for S3 authentication|
|`secret`|N*|-|Amazon secret access key for S3 authentication|
...
:::note
Using an IAM role is recommended for production. If not provided, Amazon credentials will be used in the COPY command.
:::
...
- IAM role-based authentication on Amazon infrastructure
