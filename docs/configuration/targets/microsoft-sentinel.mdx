...
:::tip
For more details, refer to our <Topic id="sentinel/overview">Microsoft Sentinel Overview</Topic> and <Topic id="sentinel-integration">Microsoft Sentinel Integration</Topic> chapters.
:::
## Schema
