...
:::tip
For more details, refer to our [Microsoft Sentinel Automation](../../microsoft-sentinel/overview.mdx) and [Microsoft Sentinel Autodiscovery](../../microsoft-sentinel/integration/via-autodiscovery.mdx) documentation.
:::
