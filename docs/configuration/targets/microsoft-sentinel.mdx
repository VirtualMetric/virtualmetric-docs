...
:::tip
For more details, refer to our (../../microsoft-sentinel/overview.mdx) and [Microsoft Sentinel Autodiscovery](../../microsoft-sentinel/integration/via-autodiscovery.mdx) documentation.
:::
