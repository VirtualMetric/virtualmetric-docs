...
:::tip
For more details, refer to our [overview](../../microsoft-sentinel/overview.mdx) and [Microsoft Sentinel Autodiscovery](../../microsoft-sentinel/integration/via-autodiscovery.mdx) documentation.
:::
## Schema
...
<small>* Conditionally required</small>
