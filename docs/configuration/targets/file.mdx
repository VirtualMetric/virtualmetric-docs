...
|`compression`|N|`"zstd"`|Compression algorithm. For [Avro](../../appendix.mdx#avro) `ztsd`, `snappy`, `deflate`; for [Parquet](../../appendix.mdx#parquet) `zstd`, `snappy`, `brotli`, `gzip`, and `lz4`|
