...
|`compression`|N|-|Compression algorithm. See applicable <Topic id="appendix-file-formats">Appendix</Topic> section|
|`extension`|N|Matches `type`|Custom file extension|
|`schema`|N|-|Data schema for <Topic id="appendix-avro">Avro</Topic> / <Topic id="appendix-parquet">Parquet</Topic> formats or schema template name|
...
|---|---|---|
|Avro|`ztsd`|See the relevant column of the <Topic id="appendix-avro">Appendix</Topic> section|
|Parquet|`ztsd`|See the relevant column of the <Topic id="appendix-parquet">Appendix</Topic> section|

## Examples

### JSON

Configuration for a _JSON_ output&mdash; as "json" is the default format, no need to specify it:
