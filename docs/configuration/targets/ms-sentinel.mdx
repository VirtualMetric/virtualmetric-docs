...
:::tip
For more details, refer to our [Microsoft Sentinel Automation](../../solutions/microsoft-sentinel/overview.mdx) and [Microsoft Sentinel Autodiscovery](../../solutions/microsoft-sentinel/integration/autodiscovery.mdx) documentation.
:::
