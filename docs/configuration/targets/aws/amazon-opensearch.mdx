    ...
    targets:
      - name: opensearch_output
        ...
        properties:
          index: "logs-%Y.%m.%d"
          endpoints:
            - endpoint: "https://search-domain.us-east-1.es.awsaws.com"
              region: "us-east-1"
    ...
    targets:
      - name: highvol_opensearch
        ...
        properties:
          ...
          timeout: 60
          endpoints:
            - endpoint: "https://search-domain1.us-east-1.es.awsaws.com"
              region: "us-east-1"
            - endpoint: "https://search-domain2.us-east-1.es.awsaws.com"
              region: "us-east-1"
    ```
  </CodeCol>
</ExampleGrid>
      ...
      - name: multiregion_opensearch
        ...
        properties:
          ...
          endpoints:
            - endpoint: "https://search-domain.us-east-1.es.awsaws.com"
              region: "us-east-1"
            - endpoint: "https://search-domain.eu-west-1.es.awsaws.com"
              region: "eu-west-1"
    ```
  </CodeCol>
</ExampleGrid>
