...
- AWS EC2 and ECS for consumer applications
...
targets:
  - name: sqs_with_url
    ...
    properties:
      ...
      secret: "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"
      region: "us-east-1"
      queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/application-logs"
```
...
targets:
  - name: high_volume_sqs
    ...
    properties:
      ...
      secret: "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"
      region: "us-east-1"
      queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/high-volume-logs"
      max_events: 10
      timeout: 60
```
...
targets:
  - name: production_sqs
    ...
    properties:
      ...
      secret: "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"
      region: "us-east-1"
      queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/production-logs"
      max_events: 10
      timeout: 60
      field_format: "cim"
```