...
targets:
  - name: basic_redshift
    ...
    properties:
      ...
      region: "us-east-1"
      endpoint: "my-cluster.abc123xyz789.us-east-1.redshift.awsaws.com"
      database: "analytics"
      username: "admin"
...
targets:
  - name: production_redshift
    ...
    properties:
      ...
      secret: "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"
      region: "us-east-1"
      endpoint: "prod-cluster.abc123xyz789.us-east-1.redshift.awsaws.com"
      database: "production"
