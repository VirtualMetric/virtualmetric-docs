...
|Field|Required|Default|Description|
|---|---|---|---|
|`address`|Y|-|MSK broker bootstrap server address (e.g., `b-1.mycluster.abc123.kafka.us-east-1.awsaws.com`)|
...
:::note
For IAM authentication, use AWS IAM roles and policies. IAM authentication is configured at the Amazon MSK cluster level and does not require username/password in the target configuration.
:::
...
```
b-1.clustername.xxxxxx.kafka.region.awsaws.com
```
...
targets:
  - name: basic_msk
    type: amazonmsk
    properties:
      address: "b-1.mycluster.abc123.kafka.us-east-1.awsaws.com"
      port: 9092
...
targets:
  - name: msk_serverless
    type: amazonmsk
    properties:
      address: "boot-abc123.c1.kafka-serverless.us-east-1.awsaws.com"
      port: 9098
