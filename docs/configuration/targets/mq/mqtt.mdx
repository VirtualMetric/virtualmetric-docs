...
Creates a target that publishes log messages to MQTT topics with support for batching, QoS levels, TLS encryption, and automatic retry logic. MQTT is a lightweight messaging protocol designed for IoT and resource-constrained devices.
