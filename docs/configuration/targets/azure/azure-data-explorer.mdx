...
(1) = Conditionally required. Use service principal authentication (`tenant_id`, `client_id`, `client_secret`) for explicit credentials, or omit all three fields to use Managed Identity.
