...
**Coming Soon (6 types, hidden by default):**
- macOS, Oracle Solaris, AIX, FreeBSD, OpenBSD, NetBSD
...
- **Connection Status Dropdown** - Filter by connection state (Pull devices only)
  - All - Show all devices
...
This alert does not appear for Pull devices as they can use Agent-based collection.
