...
<ExampleGrid>
  ...
  <CodeCol>
    ...
    - id: 1
      ...
      properties:
        region: "us-east-1"
        queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/cloudtrail-events"
    ```
  </CodeCol>
  <CommentCol>
  ...
  <CodeCol>
    ...
    - id: 2
      ...
      properties:
        ...
        queue_url: "https://sqs.us-west-2.awsaws.com/123456789012/app-logs"
  ...
  <CodeCol>
    ...
    - id: 3
      ...
      properties:
        ...
        queue_url: "https://sqs.eu-west-1.awsaws.com/987654321098/partner-events"
        timeout: 5
    ```
  </CodeCol>
  <CommentCol>
...
<ExampleGrid>
  ...
  <CodeCol>
    ...
    - id: 4
      ...
      properties:
        region: "us-east-1"
        queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/bulk-data"
        timeout: 1
        sqs_max_messages: 10
...
<ExampleGrid>
  ...
  <CodeCol>
    ...
    - id: 5
      ...
      properties:
        region: "us-east-1"
        queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/analytics-events"
...
<ExampleGrid>
  ...
  <CodeCol>
    ...
    - id: 6
      ...
      properties:
        region: "us-east-1"
        queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/log-archives"
...
<ExampleGrid>
  ...
  <CodeCol>
    ...
    - id: 7
      ...
      properties:
        region: "us-east-1"
        queue_url: "https://sqs.us-east-1.awsaws.com/123456789012/raw-data"
    ```
  </CodeCol>
  <CommentCol>
