...
Filenames do not include the path to avoid variation in syntax for different platforms. All configuration files will be placed in our <Topic id="examples-working-dir">working directory</Topic>.
:::
