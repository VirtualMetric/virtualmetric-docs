...
<dt>**Generator**</dt>
<dd>External system that produces raw telemetry data sent to DataStream devices, such as log collectors, network monitors, or user activity trackers.</dd>
...
<dt>**Six-Stage Processing Flow**</dt>
<dd>Complete DataStream architecture: Generator → Device → Preprocessing → Pipeline → Postprocessing → Target → Consumer.</dd>
