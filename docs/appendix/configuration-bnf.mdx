...
:::note[important]
\* Users may choose tabs or multiple spaces for indentation. However, the indentation patterns _must_ be consistent in all configuration files, and follow the patterns given in the code samples found throughout this guide.
:::
