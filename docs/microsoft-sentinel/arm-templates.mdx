...
The **Microsoft Sentinel** _Data Collection Rules_ (DCR) templates in **Director** provide standard configurations. They were designed to streamline the data ingestion while maintaining consistent data structures and optimal performance.
