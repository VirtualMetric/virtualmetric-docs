...
Best if you have already the installed **Director** and authenticated. Skip the workspace creation steps, and verify that 
...
Choose this method when you are running **Director** on non-Azure environments (on-premises servers, other cloud providers, etc.), you want to share access across multiple systems, or you need a more fine-grained control over permissions to manage credentials manually, e.g. when you require _credential rotation_ policies.
