...
graph TD
    ...
    Cores -.-> |Parallel Ingestion| SIEM2[Amazon Security Lake]
...
* **Multi-Schema Processing** - native ASIM table mapping for Microsoft Sentinel, OCSF class mapping for Amazon Security Lake, ECS field mapping for Elasticsearch, CIM compliance for Splunk
