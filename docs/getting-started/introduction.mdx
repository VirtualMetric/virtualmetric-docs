...
- <Topic id="single-node-deployment-director">Download and install **Director**</Topic>.
...
- <Topic id="single-node-deployment-agent">Download and install **Agent**</Topic>.

:::info
To access the executables from any directory, make sure to add `<vm_root>` to your `$PATH` environment variable.
