...
Once you are done with the above, you can proceed to the following examples to explore the basics of configuring telemetry flows and see **Director**, **Geneerator**, and **Agent** in action.
