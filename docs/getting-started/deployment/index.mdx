...
|--:|:--|:--|
|[**Local**](./local.mdx)|Run **DataStream** on your own hardware|Development, testing, or small-scale deployments|
|[**Azure VM**](./azure-vm.mdx)|Deploy on Azure Virtual Machines|Production workloads with custom configurations|
|[**Azure App Service**](./azure-app-service.mdx)|Run as a managed service|Simplified operations with automatic scaling|
|[**Azure Functions**](./azure-functions.mdx)|Event-driven serverless deployment|Cost-effective processing of intermittent workloads|
|[**Azure Arc Extension**](./azure-arc-extension.mdx)|Deploy to hybrid or multi-cloud environments|Consistent management across diverse infrastructure|
