...
2. **Route Configuration Modal**
   ...
   **Insert Pipeline:**
   - Click <gui>Insert pipeline within the route</gui> 
...
3. **Select Your Pipeline**
   ...
   - **Confirm selection**: Click <gui>Select pipeline</gui>
...
5. **Save Your Route**
   ...
   - Click <gui>Save route</gui> (blue button at bottom)
...
- Click the <gui>+</gui> button in the middle of your connection line
...
- Modify pipeline selections using <gui>Change</gui> or <gui>Remove</gui> options
