...
2. **Start Target Creation**
   - Click <menu>Add new target</menu>
...
**Learn More**: For detailed configuration of all target types, see our <Topic id="targets-overview">Target Configuration Guide</Topic>.
