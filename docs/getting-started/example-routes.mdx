# Example: Routing Telemetry Data
...
See the introductory chapters for configuring [targets](/docs/getting-started/example-targets.mdx) and [pipelines](/docs/getting-started/example-pipelines.mdx).
:::
