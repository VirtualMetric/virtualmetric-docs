...
Pipelines collect data points from producers, reshape them with [processors](/docs/configuration/pipelines/processors/index.mdx), and then send them to consumers.
