...
Now that the deployment is complete, you can see **Director** in action by trying the following examples:

* Configuring [A Syslog Device](/docs/getting-started/example-devices.mdx)
* Configuring [A Sentinel Target](/docs/getting-started/example-targets.mdx)
* [Routing Telemetry Data](/docs/getting-started/example-routes.mdx)
* Configuring [A Syslog To Sentinel Pipeline](/docs/getting-started/example-pipelines.mdx)
