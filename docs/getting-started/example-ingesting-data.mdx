...
First, we will use UDP as our listening protocol. We will do this in two ways:
...
We will now create a _target_ in the next section to forward the data we have ingested through the device we have defined here.
