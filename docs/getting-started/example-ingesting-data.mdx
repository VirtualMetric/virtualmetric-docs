...
Create a text file named `syslog-to-console.yml` in our [working directory](./configuration-basics.mdx#working-directory), and then open it with a text editor to enter the following:
...
After you press <kb-short>Enter</kb-short>, Generator will pause for a number of seconds, and then it will start sending our message to _Syslog_. It will signal that it started sending messages with a prompt like this:
