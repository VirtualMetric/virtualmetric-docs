...
Create a text file named `udp-syslog.yml` in our [working directory](./configuration-basics.mdx#working-directory), and then open it with a text editor to enter the following:
