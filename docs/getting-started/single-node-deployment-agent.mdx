...
Once you have downloaded the binary, open a terminal with admin privileges. Create the directory where you want to run **Agent** if you haven't [already done so](./overview.mdx#deployment), and copy the downloaded binary to it. Then, navigate to that directory.
