...
<Tabs>
  <TabItem value="powershell" label="PowerShell" default>
    ...
    Set-Location "C:\Program Files\VirtualMetric"  </TabItem>
...
<Tabs>
  ...
  <TabItem value="bash" label="Bash">
    ...
    ~: systemctl status vmetric-agent
       vmetric-agent.service - VirtualMetric Agent handles the monitoring of local and remote de>
          Loaded: loaded (/etc/systemd/system/vmetric-agent.service)
          Active: active (running) since Tue 2025-06-24 08:52:53 UTC;
        Main PID: 1953 (vmetric-agent)
       ...
       etc. 
    ```
  </TabItem>
