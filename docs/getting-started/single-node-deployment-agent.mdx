...
<Tabs>
  <TabItem value="powershell" label="PowerShell" default>
    ```PowerShell
    Copy-Item -Path C:\Users\username\Downloads\vmetric-agent.exe -Destination "C:\Program Files\VirtualMetric"
...
<Tabs>
  <TabItem value="powershell" label="PowerShell" default>
    ...
    ------   ----               -----------
    Running  vmetric-agent      VirtualMetric Director
    ```
  </TabItem>
  <TabItem value="bash" label="Bash">
    TODO: Check the status when service is stopped
