...
{/* TODO: Replace with http://127.0.0.1:8890/dl */}
...
Once you have downloaded the binary, open a terminal with admin privileges. Create the directory where you want to run **Agent** if you haven't [already done so](./introduction.mdx#deployment), and copy the downloaded binary to it. Then, navigate to that directory.
