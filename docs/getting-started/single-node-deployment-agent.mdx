...
<Tabs>
  <TabItem value="powershell" label="PowerShell" default>  
    ...
    ```PowerShell
    $p="C:\Program Files\VirtualMetric"; Invoke-WebRequrest dl.vget.me | Invoke-Expression
    ```
  </TabItem>
...
<Tabs>
  <TabItem value="powershell" label="PowerShell" default>
    ```PowerShell
    Copy-Item -Path C:\Users\%USERPROFILE%\Downloads\vmetric-agent.exe -Destination "C:\Program Files\VirtualMetric"
...
If you _do_ have the required (i.e. administrative) privileges, you can install/uninstall **Agent** as a service with the the following command:
