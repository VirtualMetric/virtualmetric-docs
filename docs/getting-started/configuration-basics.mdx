...
:::tip
For convenience, you may want to add **VirtualMetric**'s root folder to your `$PATH` environment variable. Otherwise, you must navigate to that folder and add the platform-specific escape ("`.\`" for Windows, "`./`" for Unix-based systems) to call **Director**'s executable.
:::
