...
2. **Start Director Creation**
   - Click the blue <menu>Create director</menu> button
...
4. **Create the Director Record**
   - Click <menu>Create director</menu>
...
4. **Verify Connection**
   - Click the <menu>Verify connection</menu> button in the **DataStream** interface
   - Wait for the "Connection successful" message
   - If connection fails, check network connectivity and firewall settings

5. **Complete Setup**
   - Click <menu>Complete setup</menu> to finish the process
