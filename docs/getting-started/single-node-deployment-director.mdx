...
<Tabs>
  <TabItem value="powershell" label="PowerShell" default>
    ```PowerShell
    C:\Users\username>Copy-Item -Path C:\Users\<username>\Downloads\vmetric-director.exe -Destination "C:\Program Files\VirtualMetric"
    C:\Users\username>Set-Location "C:\Program Files\VirtualMetric"
    ```
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="bash" label="Bash">
    ...
    sudo ./vmetric-director -service start
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="bash" label="Bash">
    ```bash
    sudo ./vmetric-director -service stop
    ```
  </TabItem>
</Tabs>

<Link to="./introduction.mdx#downloads" className="button button--primary" style={{ width: '400px', display: 'inline-block', textAlign: 'center'}}>Back To Introduction</Link>
