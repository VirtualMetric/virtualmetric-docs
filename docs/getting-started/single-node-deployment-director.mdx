...
Once you have downloaded the binary, open a terminal with admin privileges. Create the directory where you want to run **Director** if you haven't [already done so](./overview.mdx#deployment), and copy the downloaded binary to it. Then, navigate to that directory.
...
<Link to="./overview#downloads" className="button button--primary" style={{ width: '400px', display: 'inline-block', textAlign: 'center'}}>Back To Overview</Link>
