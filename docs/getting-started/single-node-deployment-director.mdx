...
<Tabs>
  ...
  <TabItem value="bash" label="Bash">
    ...
    ~: systemctl status vmetric-director
       vmetric-director.service - VirtualMetric Director handles the monitoring of local and remote de>
          Loaded: loaded (/etc/systemd/system/vmetric-director.service)
          Active: active (running) since Tue 2025-06-24 08:52:53 UTC;
        Main PID: 1953 (vmetric-directo)
       ...
       etc. 
    ```
  </TabItem>
