...
:::note
For a general discussion, see our [overview](/docs/configuration/targets/index.mdx) chapter.
:::
...
You can use various target types to store your output. We will provide an example for these below.
...
The size we want for storage here is roughly _512MB_.
