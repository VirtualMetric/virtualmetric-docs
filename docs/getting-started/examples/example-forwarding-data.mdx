import ConfigFilesWarning from './_config-files-warning.mdx';
...
Check the log file indicated [earlier](./user-notes.mdx#logging-setup). If there were no errors during the trial, it should be blank.
