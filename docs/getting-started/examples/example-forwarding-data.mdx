...
:::note
Mapping the data fields of disparate log formats to widely known [ECS](../../appendix.mdx#ecs) fields is one of the commonly used [normalization](../../configuration/pipelines/normalization.mdx) techniques.
:::
