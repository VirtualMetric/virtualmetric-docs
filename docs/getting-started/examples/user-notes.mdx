...
- <Topic id="example-ingesting-data">**Example: Ingesting Data**</Topic> - Configure your first device to receive streaming data
...
- <Topic id="example-forwarding-data">**Example: Forwarding Data**</Topic> - Configure your first target to send streaming data

- <Topic id="example-reading-json-with-a-pipeline">**Example: Reading JSON With a Pipeline**</Topic> - Configure your first pipeline to receive and process data
...
- <Topic id="example-log-collection-with-agent">**Example: Log Collection with Agent**</Topic> - Configure your first device to receive streaming data
