...
You can now proceed to the examples to explore the basics of configuring telemetry flows.

See **Director** in action:

- <Topic id="example-ingesting">**Example: Ingesting Data**</Topic> - Configure your first device to receive streaming data

- <Topic id="example-secure-ingestion">**Example: Secure Ingestion**</Topic> - Reconfigure your device to receive streaming data securely

- <Topic id="example-forwarding">**Example: Forwarding Data**</Topic> - Configure your first target to send streaming data
...
- <Topic id="example-syslog-to-json">**Example: A Syslog-To-JSON Data Stream**</Topic> - A full, end-to-end data stream in action

See **Agent** in action:

- <Topic id="example-centralized-monitoring">**Example: Centralized Monitoring with Agent**</Topic> - Configure your first device to receive streaming data

- <Topic id="example-process-management">**Example: Process Management with Agent Supervisor**</Topic> - Reconfigure your device to receive streaming data securely
