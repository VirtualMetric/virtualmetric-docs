...
- <Topic id="example-a-syslog-to-json-data-stream">**Example: A Syslog-To-JSON Data Stream**</Topic> - A full, end-to-end data stream in action

See **Agent** in action:

- <Topic id="example-centralized-log-collection-with-agent">**Example: Centralized Log Collection with Agent**</Topic> - Configure your first device to receive streaming data

- <Topic id="example-service-management-with-supervisor">**Example: Service Management with Supervisor**</Topic> - Reconfigure your device to receive streaming data securely
