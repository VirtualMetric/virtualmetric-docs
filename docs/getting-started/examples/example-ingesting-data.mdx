...
Check **Director**'s logs&mdash;the files in the directory indicated [here](./overview.mdx#logging-setup)&mdash;for any error messages. If there were no errors, it should be blank.
