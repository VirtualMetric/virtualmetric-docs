...
For complete details on predefined Agent definition IDs and security event collections, see <Topic id="appendix-agent-names">Appendix</Topic>.
:::
...
<Include id="info-live-config-updates" />
