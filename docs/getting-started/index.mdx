...
After completing your deployment, review [Configuration Basics](/docs/getting-started/configuration-basics.mdx) to get a glimpse of how you will use **Director**.
