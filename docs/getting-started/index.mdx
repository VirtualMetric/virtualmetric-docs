...
4. After completing your deployment, review [**Configuration Basics**](./configuration-basics.mdx) to get a glimpse of how you will tell **Director** what to do.

5. As soon as you learn how to configure YAML files as **Director** expects them and to invoke the processes these files spawn from the **CLI**, you can proceed to the following **Examples** to exercise what you have learned:
