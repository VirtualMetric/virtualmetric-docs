...
After completing your deployment, review the [Configuration Basics](/docs/getting-started/basics.mdx) section to get a glimpse of the various items you will use with **Director** to configure and run pipelines. Then, you can see **Director** in action by trying the following introductory examples in the indicated order:
