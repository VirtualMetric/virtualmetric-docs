...
After completing your deployment, review the [Basics](/docs/getting-started/basics.mdx) section to get a glimpse of the various components you will use with **Director**.
