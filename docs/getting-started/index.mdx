...
Once you have picked the one that suits your needs, you can use the following for your deployment:

* **Single Node Deployment**: deploying on a [single machine](./single-node-deployment.mdx)

* **Cluster Deployment**: deploying on [multiple machines](./cluster-deployment.mdx) (including the cloud)
