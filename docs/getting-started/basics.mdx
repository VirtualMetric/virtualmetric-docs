...
```yaml
component-kind1:
  - entry1-identifier: identifier1
    entry1-field1: value
    entry1-field2:
      - value1
      - value2
    ...
  - entry2-identifier: identifier2
    entry2-field1: value
    ...
component-kind2:
  - entry1-identifier: identifier1
...
:::note
The **Schema** sections of the chapters for various kinds of components provide the fields used by them.
:::
