...
:::warning[attention]
In the YAML file, the type of the component (device, target, pipeline, or route) has to be specified at the top level prefixed with a dash and followed by a colon, e.g.
...
Then, you can enlist the relevant details of the component, i.e. fields, formats, patterns, etc.
:::
