...
Wherever you place your files, you have to keep in mind a few details while creating and editing configurations: they must be structured as mentioned in the **Definition Syntax** section of [Configuration Overview](/docs/configuration/index.mdx).
