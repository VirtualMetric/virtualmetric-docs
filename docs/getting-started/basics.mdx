...
:::warning[attention]
In the YAML file, the type of the components you will declare (_devices_, _targets_, _pipelines_, or _routes_) has to be specified at the first level, and must be prefixed with a dash and followed by a colon, e.g. `- devices:` -or- `- pipelines:`.
:::
