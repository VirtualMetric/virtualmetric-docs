...
This chapter will help you get started with devices to ingest data with specific protocols, walking you through some common scenarios.
...
:::note
Each device type provides specific options detailed in its respective [chapter](/docs/configuration/devices/).
:::
...
You can now proceed to configuring and using
