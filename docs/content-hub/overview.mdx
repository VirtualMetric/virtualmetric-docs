...
- Cloud platform integrations (Azure, Amazon, Google Cloud)
...
- <gui>Install Template</gui> button available in header
...
- **Actions menu** provides management operations:
  - <gui>Manage Dependencies</gui> - Update optional and required dependencies (only shown if dependencies exist)
  - <gui>See Installed Pipeline</gui> - Navigate to the installed pipeline detail page
...
- <gui>Show More</gui> / <gui>Show Less</gui> buttons for lists exceeding 5 items
...
For installed templates with dependencies, use <gui>Manage Dependencies</gui> action to:
...
- Template detail page provides access to installed pipeline via <gui>See Installed Pipeline</gui> action
...
- <gui>Review Update</gui> - Action button to access update review interface
- **Actions Menu** - <gui>Review Update</gui> option added to pipeline actions menu
...
- Select <gui>Review Update</gui> from pipeline Actions menu
...
4. **Accept Changes**
   - Click <gui>Accept Changes</gui> button to apply updates
