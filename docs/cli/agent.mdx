...
* Compare Versions:
  ...
  ```bash
  vmetric-agent -compareVersion=2.1.0
  ```
...
* With **Generator**:
  ...
  ```bash
  vmetric-agent -mode=console -filter="generator"
  ```

**Agent** provides a robust foundation for distributed data collection and management, offering flexible deployment options and comprehensive monitoring capabilities.
