...
Unlike classic solutions that focus solely on data collection via protocols or third-party agents, _Datasets_ categorize data&mdash;Windows Event Logs, Windows User Activity, Linux Audit Logs&mdash;at the source, simplifying pipeline design and enabling advanced RBAC.
