...
The content access panes display prominent features of the content, in this case that it has Microsoft Sentinel integration.
...
## Acccessing the Content

To access the content, all you have to do is clicking on its pane.

<img src={ContentHubZscalerContentDisplayed} style={{maxWidth: "100%"}} />

On the left-hand side, there will be general information about the solution such what it does, how it does it, what inputs it can handle, what outputs are to be expected, etc.
