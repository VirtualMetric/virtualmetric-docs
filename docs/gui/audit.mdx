...
<Image id="audit-dashboard" width="100%" alt="Audit dashboard full view"/>
...
<Image id="audit-dashboard-search" width="100%" alt="Audit dashboard with search"/>
...
<Image id="audit-dashboard-filter-applied" width="100%" alt="Audit dashboard with filter applied"/>
