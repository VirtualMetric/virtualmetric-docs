...
The main audit dashboard displays a chronological record of all system activities:
...
Use the search feature to quickly locate specific audit records:
...
Apply sophisticated filters to analyze specific aspects of system activity:

<img src={AuditDashboardFullFilterApplied} style={{maxWidth: "100%"}} />

The filtering system provides multiple filter criteria:
