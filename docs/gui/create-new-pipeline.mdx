...
<Image id="create-new-pipeline" width="100%" alt="Create new pipeline full view"/>
...
<Image id="create-new-pipeline-device-type" width="50%" alt="Create new pipeline device type"/>
...
<Image id="create-new-pipeline-device-vendor" width="50%" alt="Create new pipeline device vendor"/>
...
<Image id="create-new-pipeline-target" width="50%" alt="Create new pipeline target"/>
...
<Image id="create-new-pipeline-filled-in" width="100%" alt="Create new pipeline filled in"/>
...
<Image id="create-new-pipeline-child-add" width="100%" alt="Create new pipeline child add"/>
...
<Image id="create-new-pipeline-child-add-filled-in" width="100%" alt="Create new pipeline child add filled in"/>
...
<Image id="create-new-pipeline-details" width="100%" alt="Create new pipeline details"/>
...
<Image id="create-new-pipeline-child-delete" width="100%" alt="Create new pipeline child delete"/>
...
<Image id="create-new-pipeline-edit-mode" width="100%" alt="Create new pipeline edit mode"/>
