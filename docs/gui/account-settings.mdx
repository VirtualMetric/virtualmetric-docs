...
import AccountSettingsFullPasswordChange from '../assets/gui/account-settings-full-password-change.png';
...
- Click your profile icon <img src={WelcomeProfileIcon} style={{maxWidth: "5%"}} /> on the top right corner to open the following menu:
...
<img src={AccountSettingsFullPasswordChange} style={{maxWidth: "75%"}} />
