...
Action buttons are typically located on the right side of each pipeline entry.
...
- Bulk action buttons appear when one or more pipelines are selected
- Available bulk actions include deletion and status changes
