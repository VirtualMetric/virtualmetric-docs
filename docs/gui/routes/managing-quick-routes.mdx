...
1. **Select a device** - Under the **Devices** label, click the **Select device** button.

   This opens a window with two tabs:

   - **Select Device** - Select an existing device, then
     - Tick the checkboxes of the devices you want to select
     - Click the blue **Select Device(s)** button
   - **Choose Device Type** - Create a new device by selecting a type. Click the blue **Choose device type** button to begin.
...
2. **Select a target** - Under the **Targets** label, click the **Select target** button.

   This opens a window with two tabs:

   - **Select Target** - Select an existing target.
...
3. **Connect and configure the route** - Once devices and targets are selected and moved to the canvas, you can connect them.
...
To edit a quick route, go to the **Quick Routes** view.

You can edit the following items:

1. **Edit pipelines** - To edit the route's pipeline(s),
...
2. **Edit devices** - To edit the route's devices,
...
3. **Edit targets** - To edit the route's targets,
