...
On the right, there is an **Actions** dropdown, offering options to _Disable_, _Clone_, or _Delete_ the route.
...
- **Filter** - A boolean expression for including or excluding data items. (See **Confitional Routing** in <Topic id="routes-implementation-strategies">**this section**</Topic>.)
