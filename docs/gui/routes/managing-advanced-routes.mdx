...
- **Filter** - A boolean expression stating the conditions for inclusion/exclusion a data items. (See **Confitional Routing** in <Topic id="routes-implementation-strategies">**this section**</Topic>.)
...
Clickin the blue **Manage route configuration** button activates the editing area.
