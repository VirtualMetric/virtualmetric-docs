...
Under the main header, there is a **Search pipelines** box you can use to search for pipelines by name.
...
The edit line (pencil) on the right activates a form under it where you can modify the settings of the pipeline.
...
On the left sidebar, you will also notice an “Add new child pipeline” button with a `+` on its right. You can use this button to add dependent pipelines to which your pipeline can delegate certain processing jobs.
