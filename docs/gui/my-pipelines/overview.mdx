...
Next to each row is a vertical ellipsis (&#x22EE;) that opens the **Actions** dropdown. Available opğtions are _Edit pipeline details_ and _Delete pipeline_.
...
- **Target** (Optional) - Dropdown listing various target taypes
