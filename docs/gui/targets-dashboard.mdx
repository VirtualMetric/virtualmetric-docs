...
<Image id="targets-add-new-target-step1-general-info" width="75%" alt="New target creation step 1 showing general information form with name and type selection"/>
...
#### Disabled State
<Image id="targets-add-new-target-step2-azure-properties-disabled" width="75%" alt="Azure properties configuration form in disabled state before target type selection"/>

#### Enabled State
<Image id="targets-add-new-target-step2-azure-properties-enabled" width="75%" alt="Azure properties configuration form showing enabled fields for Azure Sentinel connection"/>
...
<Image id="targets-add-new-target-step3-streams-automatic" width="75%" alt="Automatic stream configuration showing auto-detected data streams and routing options"/>

#### Manual Stream Configuration
<Image id="targets-add-new-target-step3-streams-manual" width="75%" alt="Manual stream configuration interface for custom data stream routing and filtering"/>
...
<Image id="targets-sentinel-clone" width="75%" alt="Target cloning dialog showing options to duplicate configuration with modifications"/>
