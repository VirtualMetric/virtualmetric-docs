...
After installation, the template content appears as a pipeline in **DataStream**. See <Topic id="gui-managing-templates">Managing Templates</Topic> for installation and management steps.
