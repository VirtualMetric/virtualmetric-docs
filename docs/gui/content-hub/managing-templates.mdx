...
When you click the installation button, the view navigates to the **Pipelines** section. The installed template's name is displayed at the top of this view.

You can now modify the downloaded template's pipeline and its child pipelines' details.

### Template Status

Once a template is installed, it displays an **installed** label in the main **Content Hub** view cards. It also becomes a pipeline in **DataStream**.
