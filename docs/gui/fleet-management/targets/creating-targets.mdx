...
Configure Azure-specific connection parameters for Sentinel and other Azure targets. The system dynamically enables or disables Azure-specific fields based on the target type selected in Step 1.
