...
- **Azure Blob Storage** targets include Azure Blob Storage for data archiving and real-time analytics.
...
The **Actions** drapdown (⋮) for each target offers the _Edit_, _Clone_, _Enable_/_Disable_, and _Delete_ options.
