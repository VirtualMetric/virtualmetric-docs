...
- **Azure Blob Storage** targets include Azure Blob Storage for data archiving.

- **Azure Data Explorer** targets send data to **Azure Data Explorer** for real-time analytics.
...
- **Post-processing Pipeline** - Pipeline used for postprocessing. See <Topic id="normalization">Normalization</Topic> for details
- **Status** - Target is _Enabled_/_Disabled_

The **Actions** dropdown (⋮) for each target offers the _Edit_, _Clone_, _Enable_/_Disable_, and _Delete_ options.
