...
There are two deployment types:
  ...
  - **Agentless** - Uses autodetect to set up the device in your environment.
  
    Selecting this turns the button to **Next step**. Clicking the button takes you to the [**Install and Connect**](#install-and-connect-agentless) tab for Agentless.
