...
There are two deployment types:
  ...
  - **Agent** - Installs a lightweight **Agent** that sets up the device in your environment.
    ...
    Selecting this turns the blue button to **Create device**. Clicking the button takes you directly to the [**Install and Connect**](#install-and-connect---agent) tab for Agent.

  - **Agentless** - Uses autodetect to set up the device in your environment.
  
    Selecting this turns the blue button to **Next step**. Clicking the button takes you to go to the [**Install and Connect**](#install-and-connect---agentless) tab for Agentless.
