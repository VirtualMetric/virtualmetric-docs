...
The next two tabs contain device-specific configuration fields that vary by protocol type. Expand the relevant device type below for detailed configuration instructions.

<Details summary="Syslog Device Configuration">
<Include id="gui-syslog-device-config" />
</Details>

<Details summary="HTTP Device Configuration">
<Include id="gui-http-device-config" />
</Details>

<Details summary="UDP Device Configuration">
*UDP device configuration documentation coming soon*
</Details>

<Details summary="TCP Device Configuration">
*TCP device configuration documentation coming soon*
</Details>

<Details summary="eStreamer Device Configuration">
*eStreamer device configuration documentation coming soon*
</Details>

---

After making the required changes, click **Add device** to complete the process.
