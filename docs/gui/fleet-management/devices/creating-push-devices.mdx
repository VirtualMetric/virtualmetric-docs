...
The next two tabs contain device-specific configuration fields that vary by protocol type. For detailed instructions, expand the relevant device type below.
...
<Details summary="UDP">
<Include id="gui-udp-device-config" />
</Details>

<Details summary="TCP">
<Include id="gui-tcp-device-config" />
</Details>

<Details summary="eStreamer">
<Include id="gui-estreamer-device-config" />
</Details>

After making the required changes, click **Add device** to complete the procedure.
