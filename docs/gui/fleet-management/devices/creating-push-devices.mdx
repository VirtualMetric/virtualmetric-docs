...
The next two tabs, **Protocol Settings** and **Advanced Configuration**, contain device-specific fields that vary by protocol type. For detailed instructions, expand the device types below.
