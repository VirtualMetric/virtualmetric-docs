...
- A **sidebar** listing the same device types shown as cards on the **Devices** view

- A **search box** to type the name of a device to filter the list

- A **Director(s)** dropdown to filter by the director(s) that devices of this type are attached to
