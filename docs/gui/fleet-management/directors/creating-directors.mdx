...
To create a new **Director**, open **Fleet Management → Directors** and click **Add Director**. The workflow is a straightforward two-step process: provide a name and installation type, then install the director using the generated key.
