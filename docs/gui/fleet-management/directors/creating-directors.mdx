...
- Go to **Home** > **Director**
- Click the **Create director** button

This will take you to the area where you will name and install a new director. You can also manage the already installed directors here.

In the **Director Setup** tab
...
The **Connect Later** button is intended to defer this installation step. However, the not-yet-enabled director will still appear on the directors list.
...
Under the buttons, you will see a box containing a newly-generated API key. You will use this to install a **Director**.
...
- Paste the copied text in the prompt
...
:::info
Clicking the **Verify connection** button without carrying out an installation first or before the installation completes will return an error.
:::

Once the connection is verified, you will be prompted with a **Connection succesfull** message.
