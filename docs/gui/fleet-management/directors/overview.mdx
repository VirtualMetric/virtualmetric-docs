...
To the right of each row in the table, you will see the **Actions** menu button (&#x22EE;) which will open a drop-down menu containing the basic actions you can perform on a director:
