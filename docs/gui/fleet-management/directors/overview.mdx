...
At the bottom, there's a pagination button you can use to nagivate further down the list in case the number of directors available do not fit on a single page.
...
- **Platform Type** - By default _Self-mnanaged_
