...
- Click the `>` button on the right of its row
- Select **Edit director**

This will take you to the first tab of the **Director Details** view.

:::note
The options found on the table row through the `>` button are also available here from the **Actions** drop-down list on the top right.
:::
