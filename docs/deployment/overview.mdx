...
|<Topic id="deployment-on-azure-arc-extension">**Azure Arc Extension**</Topic>|Deploy to hybrid or multi-cloud environments|Consistent management across diverse infrastructure|
