...
- **Software Requirements**:
  ...
  - Container Support: Docker 20.10+ or containerd 1.6+ (if using container deployment)
...
For questions or assistance with deployment, contact our support team at support@datastream.example.com.
