...
|----------------|-------------------|------------------------|
| `http` | `http` | [HTTP Device](www.example.com) |
| `tcp` | `tcp` | [TCP Device](www.example.) |
| `udp` | `udp` | [UDP Device](www.example.) |
| `syslog` | `syslog` | [Syslog Device](www.example.) |
| `beats` | `http` | Configure as HTTP endpoint |
| `azure_event_hubs` | `azmon` | [Azure Monitor](www.example.) |
| `windows_event_log` | `windows` | [Windows Device](www.example.) |
