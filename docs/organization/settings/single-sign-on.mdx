...
- Click the <gui>Authentication</gui> tab

The **Authentication** interface displays:

- **Single Sign-On** section with setup options
- <gui>Set up Single Sign-On</gui> link for configuration access
- <gui>Learn more</gui> link for additional SSO information
...
2. **Configure Authentication Type**
   ...
   - Enable the <gui>SSO Enabled</gui> toggle
...
2. Disable the <gui>SSO Enabled</gui> toggle
