...
1. **Navigate to Access Requests**
   ...
   - Click <gui>Create new access request</gui>
...
1. **Access Tenant Management**
   ...
   - Click <gui>Create New Tenant</gui> button
...
3. Click <gui>Delete Tenant</gui> (requires confirmation)
