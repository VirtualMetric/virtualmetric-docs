...
Users must exist in both Azure AD and VirtualMetric tenant:

- **Azure AD**: Controls authentication
- **VirtualMetric Tenant**: Controls authorization and roles

When SSO is enabled, users authenticate through Azure AD but require VirtualMetric user accounts for access permissions.
