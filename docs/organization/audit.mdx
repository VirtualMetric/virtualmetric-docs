...
- <gui>Refresh</gui> button: Update the audit log display with the latest activities
...
- **Clear search**: Use the <gui>X</gui> button to quickly clear the search criteria
...
- <gui>Modify</gui> button: Edit existing filter criteria
- <gui>Clear all</gui> button: Remove all applied filters to return to full audit view
