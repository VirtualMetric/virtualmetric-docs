...
- Enter the user's full name for identification and their primary email address, which serves as both the authentication credential and notification contact.
- The email must be valid and current.
