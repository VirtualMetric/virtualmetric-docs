...
- <menu>Add new user</menu> - Primary action button to initiate user creation
...
- <menu>Manage user</menu> - Navigate to detailed user configuration
- <menu>Delete user</menu> - Remove user account (revokes all access)
- <menu>Disable user</menu> / <menu>Enable user</menu> - Toggle user access without deletion
...
1. **Access User Creation**
   - Click the <menu>Add new user</menu> button in the Users interface
...
3. **Finalize Account**
   - Click <menu>Add user</menu> to complete the creation process
...
1. **Access Deletion Options**
   - From the Users table: Select user > Actions menu (&#x22EE;) > <menu>Delete user</menu>
   - From User Details page: Click **Actions** dropdown > <menu>Delete</menu>
