...
If account creation fails, the most common cause is a duplicate email address: each email must be _unique_ within the organization.
:::
...
2. Select <gui>Delete user</gui>

Alternatively, from the **User Details** page, click <gui>Actions</gui> > <gui>Delete</gui>.
