...
The following chapters document the administration features of **VirtualMetric Director**.
...
<TermTable>
   <TermCol>[**Devices**](/docs/administration/devices/index.mdx) </TermCol>
   <DefCol>Sources of log data, e.g. syslog or estreamer</DefCol>

   <TermCol>[**Pipelines**](/docs/administration/pipelines/index.mdx) </TermCol>
   ...
   <TermCol>[**Routes**](/docs/administration/routes/index.mdx) </TermCol>
   <DefCol>Traffic control for directing data flows</DefCol>

   <TermCol>[**Targets**](/docs/administration/targets/index.mdx)</TermCol>
