...
{/* TODO: Bu ağaca bir iki örnek target koyabilir misin? */}
...
* **Microsoft Sentinel** - Direct DCR integration and ASIM normalization are supported. In addition, standard tables, WindowsEvent, SecurityEvent, CommonSecurityLog, and Syslog can also be used. The available ASIM tables are:
  - ASimAuditEventLogs
...
* **Pipelines** - Field normalization (ECS, CIM, ASIM), data transformation, message batching, custom field mapping, schema validation, and format conversion.
