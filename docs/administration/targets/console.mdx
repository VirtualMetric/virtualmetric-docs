...
<TermTable>
  <TermCol>`ecs`</TermCol>
  <DefCol>Elastic Common Schema format</DefCol>

  <TermCol>`cim`</TermCol>
  <DefCol>Splunk Common Information Model format</DefCol>

  <TermCol>`asim`</TermCol>
  <DefCol>Advanced Security Information Model format</DefCol>
