...
<table class="term-listing" >
   <tr>
      <td class="term-column">[Devices](/docs/administration/devices/overview.mdx) </td>
      <td>Sources of log data, e.g. syslog or estreamer</td>
   </tr>

   <tr>
      <td class="term-column">[Pipelines](/docs/administration/pipelines/overview.mdx) </td>
      <td>Processing workflows for data transformation</td>
   </tr>

   <tr>
      <td class="term-column">[Processors](/docs/administration/pipelines/processors/index.mdx) </td>
      <td>Individual data manipulation functions</td>
   </tr>

   <tr>
      <td class="term-column">[Routes](/docs/administration/routes/overview.mdx) </td>
      <td>Traffic control for directing data flows</td>
   </tr>

   <tr>
      <td class="term-column">[Targets](/docs/administration/targets/overview.mdx)</td>
      <td>Destinations for processed data, e.g. Sentinel or a storage system</td>
   </tr>
</table>
...
All administration tasks are carried out by editing these files. They contain predefined fields with specific data types, and **Director** uses them to run its processes.
