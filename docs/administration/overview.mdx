...
To help design the processes that will define, combine, and run the above stages, **Director** uses the files under a hierarchical structure in the `vm_root` directory:
