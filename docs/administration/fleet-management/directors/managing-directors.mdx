...
You will see a confirmation modal stating that the current API key will be revoked. Clicking **Continue** takes you to **Connection Details**, where a new API key and installation script are shown. (See <Topic id="administration-creating-directors">the previous chapter</Topic> for installation steps.)
