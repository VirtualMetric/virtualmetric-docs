...
The most common challenge in this regard is **format variations**. Make sure that you have paid enough attention to the [normalization](/docs/administration/routes/normalization.mdx) stage.
