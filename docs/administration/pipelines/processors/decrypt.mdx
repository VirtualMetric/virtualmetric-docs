...
Decrypts encrypted string values using AES encryption with a specified key and initialization vector (IV). Supports both AES-256-GCM (Galois/Counter Mode) and AES-256-CFB (Cipher Feedback) modes of operation.
