...
<span class="theme-doc-version-badge badge badge--primary">Transform</span>
...
**ASIM** - Preserves original field name casing, e.g. `User.FirstName.LastName`. See [Appendix](/docs/appendix.mdx#asim) for details.

**ECS** - Converts all field names to lowercase, e.g. `user.firstname.lastname`, and uses the specified delimiter. Defaults to dot notation. See [Appendix](/docs/appendix.mdx#ecs) for details.

**CIM** - Converts all field names to lowercase, e.g. `user.firstname.lastname`. See [Appendix](/docs/appendix.mdx#cim) for details.
