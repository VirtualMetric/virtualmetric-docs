...
Generates a cryptographic hash of specified document fields to create a unique fingerprint. Supports multiple hash algorithms and can handle complex data types including nested objects and arrays.
