...
**Functionality**: Generates a cryptographic hash of specified document fields to create a unique fingerprint. Supports multiple hash algorithms and can handle complex data types including nested objects and arrays.
...
The processor ensures consistent hashing by sorting the object keys before hashing, using delimiters between values, and converting various data types to bytes uniformly:
