---
description: Interprets values as dates
---
...
**Functionality**: Features an advanced timestamp parser that can automatically detect and parse a wide variety of date/time formats without requiring explicit format specification.
...
The processor supports nearly all timestamp formats, including:
