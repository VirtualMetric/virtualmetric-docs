...
Enriches log data by performing SQL queries against lookup tables loaded from CSV files or datasets. It can then join the log data with externally referenced information to add context and information.
