...
Determines network traffic direction by analyzing source and destination IP addresses against defined internal networks. The processor classifies traffic as inbound, outbound, internal, or external based on whether IPs belong to specified internal networks.
