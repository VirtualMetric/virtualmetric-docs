...
Parses XML-formatted strings into structured maps. The processor converts XML documents into nested map structures, handling complex scenarios like nested elements, attributes, and mixed content.
