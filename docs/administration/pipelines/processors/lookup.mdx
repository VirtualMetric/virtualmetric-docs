...
<span class="theme-doc-version-badge badge badge--primary">Enrich</span><span class="theme-doc-version-badge badge badge--secondary">Cribl Compatible</span>
...
**Functionality**: Enriches log events by looking up values in a CSV file and adding corresponding fields to the event. Supports multiple matching modes, case-sensitive/insensitive matching, and various ways to handle multiple matches.
