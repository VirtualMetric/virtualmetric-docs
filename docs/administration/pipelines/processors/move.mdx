---
description: Changes the location of fields
---
...
Moves fields from one location to another within the document structure. Supports moving nested fields, pattern matching, and exclusions. Can move fields to a specific target field or to the root level of the document.
