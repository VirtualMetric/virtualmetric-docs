...
See <a target="_self" href={linkFor('normalization')}>normalizion</a> for details.
...
As can be seen from the graphics, the components in the middle of this setup are actually called [routes](/docs/administration/routes/index.mdx).
