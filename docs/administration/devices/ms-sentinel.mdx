...
<span class="theme-doc-version-badge badge badge--secondary">Microsoft Azure</span><span class="theme-doc-version-badge badge badge--secondary">Pull</span>
...
Incidents are automatically normalized with ECS field mapping in addition to using consistent timestamp formats, structured label handling, and owner information. (See [Appendix](/docs/appendix.mdx#ecs) for details of ECS.)
