...
Director searches the `<director_root>/config` directory recursively for files with `.yaml` or `.yml` extensions. You can organize your configurations in several ways:
