...
Creates a server that accepts network messages over UDP connections. Supports high-performance message ingestion with configurable workers and buffering options.
