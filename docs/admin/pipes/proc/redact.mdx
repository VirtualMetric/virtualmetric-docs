...
<Synopsis>
Uses the Grok rules engine to obscure text in the input document matching given Grok patterns. Can be used to cloak _Personally Identifiable Information_ (PII) using known patterns such as email or IP addresses.
</Synopsis>
...
|---|---|---|---|
|`field`|Y|N/A|The field to be redacted|
...
TODO: Create original values

TODO: Compare the functionality to ours
