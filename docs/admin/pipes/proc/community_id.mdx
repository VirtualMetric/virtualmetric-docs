...
:::info[synopsis]
Computes the **Community ID** for network flow data, as defined in the [Community ID Specification]. The community ID Use to correlate network events related to a single flow. By default, reads network flow data from related **ECS**.
:::
