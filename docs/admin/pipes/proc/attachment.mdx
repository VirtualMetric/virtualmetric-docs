...
|`on_success`|Strings|N|-|Use to inform the user that no errors were raised or to specify the next processor to run|
...
|`remove_binary`|Logical|N||If `true`, the binary field will be removed from the document|
