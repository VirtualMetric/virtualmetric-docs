...
:::note
Unlike error handling, success handlers do not interrupt the normal pipeline flow. After executing `on_success` processors, **Director** continues with the next processor in the pipeline.
:::
