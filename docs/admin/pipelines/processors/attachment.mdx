...
<ExampleTable>
	<Description>
   The field **data** contains the attachment as a base64-encoded string.
	</Description>
	<SampleCode>
   ```json
   {
...
* **Property extraction** The exported fields listed above can be used to drill down to the properties of the document:
...
<ExampleTable>
   <Description>
      Specifying the **indexed chars field**...
   </Description>
   <SampleCode>
   ```yaml
   attachment:
