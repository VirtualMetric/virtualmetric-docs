...
|---|---|---|---|
|`dataset_name`|Y||Field containing the dataset to be used for enrichment|
|`lookup_table`|Y||Field containing the table to be used to correlate with dataset|
|`query`|Y||Criteria to use against `lookup_table`|
