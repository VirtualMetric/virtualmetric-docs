...
|---|---|---|---|
|`field`|Y||Field containing the grok expression to be parsed|
|`patterns`|Y||Ordered list of grok expressions to match with named captures. Returns the first match|
