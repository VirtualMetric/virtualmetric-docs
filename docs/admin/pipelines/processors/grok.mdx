...
<Synopsis>
Extracts structured fields from a single text field within a document using pre-defined regular expression-based patterns.
</Synopsis>
...
<Example>
	<Description>
	Grab event time from:
	</Description>
	<SampleCode>
		```yaml
		_raw: "2024-10-16T04:15:10.55+01:00 DEBUG Sample message"
		```
	</SampleCode>
