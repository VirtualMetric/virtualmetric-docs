...
* between **Sources** and **Routes**: the purpose here is to prepare the data for the **Routes** that will select the relevant data points using filters
...
* between **Routes** and **Targets**: the purpose here is to prepare the data points for the post-procesing stage where they are relayed to specific **Targets**
