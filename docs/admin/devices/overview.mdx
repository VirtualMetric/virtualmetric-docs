...
There is also a category of devices that cannot be accessed remotely but nevertheless publish their data. The streams from these can be be collected via certain protocols&mdash;e.g. Syslog, Netflow.

## Typical Uses

Let us assume we have the following **Syslog** device configuration:
