...
:::note
The worker count cannot be less than 1 or more than the maximum number of physical cores available on the system. Otherwise, this setting will be automatically capped by the available CPU cores.
:::
