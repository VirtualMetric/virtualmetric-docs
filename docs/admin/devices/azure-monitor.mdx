...
For collecting multiple log types with pre-processing:

<ExampleGrid>
  <CommentCol>
    Collect multiple log streams with custom processing...
  </CommentCol>
  <CodeCol>
    ```yaml
    - id: 2
...
For enhanced performance with high log volumes:
