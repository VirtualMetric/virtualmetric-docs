...
- **Sticky Button Areas** - Add and cancel buttons are now fixed in place when working with long device and target lists. Makes it easier to perform actions without scrolling, enhancing user experience and reducing clicks when managing multiple sources and destinations.
